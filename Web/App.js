    ...
    return (
      <header>
        ...
        <div className="contenuH">
          <p className="titleH">En un clic et vous mangez </p>
          <p className="paragrapheH">DeliBouff une application qui selectionnera pour vous les meilleurs adresses selons vos préferences. Téléchargez l'app et testez !</p>
        </div>      
      </header>
    )
  }
      ...
      <main>
        <div className="globalmain">
          <div className="textmain">
            <span className="boule">
              ...
              <div className="textB">
                <p className="titleb">Avec geolocalisation</p>
                <p className="descb">Des restaurants de qualité mais également un service pratique et rapide.</p>
              </div>
            ...
            <span className="boule">
              ...
              <div className="textB">
                <p className="titleb">Trajet</p>
                <p className="descb">Ici le client est Roi, on vous garantit une livraison en dessous de 20min !</p>
              </div>
            </span>
            ...
            <span className="boule">
              ...
              <div className="textB">
                <p className="titleb">L'app</p>
                <p className="descb">Application disponible dès maintenant gratuitement.</p>
              </div>
            </span>
          </div>
        </div>
        ...
        <div className="cucuy">
          <div className="imgtextdivref">
            ...
            <div className="caca">
              <p className="pcontentitle">Notre plus</p>
              <p className="pcontent">Le point fort de DeliBouff est bien son temps records de livraison. Nos coursiers sont bien évidemment salariés tout travail m'érite salaire. </p>
            </div>
          </div>

          <div className="imgtextdiv">
            <div className="caca">
              <p className="pcontentitle">l'application</p>
              <p className="pcontent">Pour l'instant l'app est disponible sur Android seulement, des mises à jours sont à prevoires. Une version IOS est en développement.</p>
            </div>
          ...
          <div className="imgtextdiv">
            ...
            <div className="caca">
              <p className="pcontentitle">Communication</p>
              <p className="pcontent">Notre entreprise est encore très jeunes, nous avons encore besoin de créer une vrai communeauté. Pour ce faire n'hésitez pas à nous suivre sur les réseaux ! *voir bas de page</p>
            </div>
          </div>

          <div className="imgtextdiv">
            <div className="caca">
              <p className="pcontentitle">Donnez nous votre ressenti</p>
              <p className="pcontent">Nous receuillons avec beaucoups d'attention vos avis, il est important pour nous d'adapter nos services pour assurer la meilleure satisfaction possible.</p>
            </div>
